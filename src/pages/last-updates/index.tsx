...
import { breakName } from '../real-state'
              ...
              >
                ...
                <Box
                  sx={{
                    ...
                    gridTemplateColumns: {
                      xs: '1fr',
                      sm: '130px minmax(80px, 1fr) minmax(150px, 1fr) minmax(100px, 1fr) minmax(100px, 1fr) minmax(100px, 1fr)',
                      md: '150px minmax(80px, 1fr) minmax(150px, 1fr) minmax(100px, 1fr) minmax(100px, 1fr) minmax(100px, 1fr)'
                    },
                    flex: 1,
                    gap: '0.5rem',
                    width: '100%'
